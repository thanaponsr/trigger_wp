 ...
 * @since 0.1
 */
class Education_Soul_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'education_soul';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar(
				array(
					'name'          => sprintf( __( 'Footer Widget %d', 'education-soul' ), $i ),
...
// Initialize.
$education_soul_footer_widgets = new Education_Soul_Footer_Widgets();
