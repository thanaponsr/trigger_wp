 ...
 * @since 0.1
 */
class Education_Soul_Widget_Base extends WP_Widget {
		...
		switch ( $field_type ) {
			...
			case 'image':
				...
				<div>
					...
					<!-- <br /> -->
					<input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'education-soul' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'education-soul' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'education-soul' ); ?>" />
					<?php
					$image_status = false;
					if ( ! empty( $value ) ) {
						$image_status = true;
					...
					?>
					<input type="button" value="<?php echo esc_attr( _x( 'X', 'remove button', 'education-soul' ) ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
