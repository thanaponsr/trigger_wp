...
class Quiz_Maker_Public
{
    ...
    /*******************************************************************************************************/
        ...
        $quiz_start_button = "<input type='button' $empty_questions_button name='next' class='ays_next start_button action-button' value='". $this->buttons_texts['startButton'] ."' />".$empty_questions_notification;
