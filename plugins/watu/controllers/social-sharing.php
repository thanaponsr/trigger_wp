...
class WatuSharing {
	...
	static function display() {
		...
		<a href="#" title="<?php _e('Share your results on Facebook', 'watu');?>" onclick="Watu.FBShare('<?php echo get_permalink($_POST['post_id'])?>', '<?php echo htmlentities(strip_tags($linkedin_title))?>', '<?php echo htmlentities(strip_tags($linkedin_msg));?>', '<?php echo $picture_str?>');return false;"><img src="<?php echo $facebook_button?>"></a>&nbsp;
